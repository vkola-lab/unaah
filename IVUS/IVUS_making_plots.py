...
annopath = '/home/eikthedragonslayer/DATA/CVS_data/CVS/Annotated'
...
phases=["test"]
backbone = 'resnet50'
predpath = '/home/eikthedragonslayer/DATA/CVS_data/CVS/pred/combined_figure'
...
class Dataset(object):
    ...
    def __getitem__(self, index):
        ...
        if self.img_transform is not None:
            img_new = self.img_transform(np_3d)
...
for k in range(5):
    ...
    dataLoader={}
    for phase in phases: 
        dataset[phase]=Dataset(f"/home/eikthedragonslayer/DATA/CVS_data/CVS/{phase}_{k}.txt",rawpath,maskpath,annopath, img_transform=img_transform, mask_transform = mask_transform)
    ...
    checkpoint3 = torch.load(f"./save/{dataname3}_{k}_unaah_{backbone}_preprocessed_model.pt")
